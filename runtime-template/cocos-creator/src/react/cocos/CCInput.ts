...
import { FiberType, InputMode, InputType } from "../Types";
...
export default class CCInput extends CCView implements Input {
    ...
    set textColor(color: { r: number; g: number; b: number; a?: number | undefined; }) {
        this._textNode.color = new cc.Color(color.r * 255, color.g * 255, color.b * 255, color.a ? color.a * 255 : 255);
    }
    get textColor() {
    ...
    set placeholderColor(color: { r: number; g: number; b: number; a?: number | undefined; }) {
        this._placeholdeNode.color = new cc.Color(color.r * 255, color.g * 255, color.b * 255, color.a ? color.a * 255 : 255);
    }
