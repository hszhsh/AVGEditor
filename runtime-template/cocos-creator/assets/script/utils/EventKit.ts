...
export class Emitter {
    ...
    on(eventName: string | symbol, handler: (...args: any[]) => void, unshift: boolean = false) {
        if (this._disposed) {
    ...
    once(eventName: string | symbol, handler: (...args: any[]) => void, unshift: boolean = false) {
    ...
    private off = (eventName: string | symbol, handlerToRemove: (...args: any[]) => void) => {
